...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-nsepj6a.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-nsepj6a.containers.anotherwebservice.com/
...
```
git clone git@github.com:daret9999/container-nsepj6a.git
cd container-nsepj6a
```
...
```
docker attach container-nsepj6a
```
